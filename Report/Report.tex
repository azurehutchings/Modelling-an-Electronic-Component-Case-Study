...
The runtime for solving $x$ using each type of storage was calculated using Matlab's built in functionality (tic and toc). The runtime
\begin{figure}[H]
