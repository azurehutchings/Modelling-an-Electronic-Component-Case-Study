...
\begin{figure}[H]
	...
	\label{fig:memory}
\end{figure}
Full Storage was found to require the most memory (8712 Bytes), whereas Band storage was found to require the least amount of memory (1848) of the Direct Methods. In terms of storage size, it's clear that storing the $A$ matrix in different types of storage, to remove the redundant information (zeroes) is very effective in reducing the need of large storage in bytes.
...
\\\\
Banded Storage took the least runtime to execute 
